...
export default defineConfig({
  shortcuts: {
    ...
    'highlight': 'bg-fg-lit-norm dark:bg-fg-drk-muted text-fg-drk-norm dark:text-fg-lit-norm py1 px2 rounded-sm shadow-sm',
    'border-base': 'border-fg-lit-norm dark:border-none',
